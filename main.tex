...
\twocolumn[\maketitle \begin{abstract}\sffamily \vspace{-1em} \input{abstract} \\ \end{abstract}]
%\begin{multicols}{2}
...
The spectral efficiency of the setup, being the accumulated product of the lamps's emission spectrum, the camera's quantum efficiency and the optics' transmittivities, is illustrated in \todo{figure of correction spectrum}. 
We deem this sufficient for wavelengths between $\SI{420}{\nano\meter}$ and $\SI{1000}{\nano\meter}$. 

\note{I'm leaving out the laser for position calibration stuff.}
...
\begin{figure}[t]
    ...
    \caption{
        ...
        %{\sffamily\textbf{B:}} \todo{Integration domain corresponding to the objective aperture.} 
    }
...
$$
    P_\mathrm{sca}(\lambda) = \oiint_{\Omega \in \mathcal{S}^2} \,\mathrm{d}\mathcal{I}(\lambda, \Omega) \ , % \ \mathrm{d}\Omega \ ,
$$
...
\note{I'm leaving out anything to do with polarization, because I'm only looking at unpolarized measurements and the description of how I define polarization in the simulation and subsequently get rid of it in the emulation feels redundant.}
...
\note{The average of }\footnote{\todo{I mean most of the individual sample spectra fit reasonably well but there are some outliers. The average fits nicely, but ultimately one of those samples is likely the truth. And they have the same limitations in regards to details lost.}} 
