...
To that end, the front aperture of the spectrograph (i.e. the slit {\sffamily{A5}}) was slowly translated across the BFP image while recording an image sequence, such that the camera would record one spectrally dispersed vertical line of the BFP image at a time. 
...
\todo{This procedure is described in detail in the supplementary material.} 
