...
\todo{figure of correction spectrum}
...
\begin{figure}[h]
    ...
    \put (-1,68) {\textcolor{ts_b}{$\hat{k}_0$}}
    \put (76,8) {\textcolor{ts_r}{$\hat{k}'$}}
    % angle labels
    \put (59,85) {$\zeta$}
    ...
    \end{overpic}
    \caption{Unit vectors and angles defining the orientation of the system.}
...
%\todo{Other accumulated measurments don't have the drop-offs at 950ish.}
