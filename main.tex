...
\todo{(check whether actually true) Note that this is not the azimuthal analogue to the polar plasmon modes described later. 
The scattering peaks associated with these modes are (?) visible at greater wavelengths, though only for side-on illumination as well.}
