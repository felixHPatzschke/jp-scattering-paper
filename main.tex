...
$$
    P_\mathrm{sca}(\lambda) = \oiint_{\mathcal{S}^2} \,\mathrm{d}\mathcal{I}(\lambda, \Omega) \ , % \ \mathrm{d}\Omega \ ,
$$
the measured value corresponds to the integration over a certain angular range, % $\mathcal{D} \subset \mathcal{S}^2$: 
$$
    P_\mathrm{sca,measured}(\lambda) = \iint_{\mathcal{D}} \,\mathrm{d}\mathcal{I}(\lambda, \Omega) \ , 
$$
...
$$
    \alpha,\mathrm{NA} \mapsto \Bigl[ \lambda \mapsto \sigma_\mathrm{sca,measured} \Bigr] \ ,
$$
i.e. a scattering spectrum $\lambda \mapsto \sigma_\mathrm{sca,measured}$ as measured for each sampled $\alpha,\ \mathrm{NA}$. 
...
Nonetheless, there is a perceptible and systematic shift of the measured scattering peaks towards the red end of the spectrum. 
