...
\subsection*{Dark-Field Spectra, Selective Illumination}
...
\subsection*{Numerical Results, Far-Field Patterns}

The simulated far-field patterns show the same results. 

\subsection*{Numerical Results, Dark-Field Spectra}
...
\todo{Also: I would expect a peak in the absorption cross-section there. Motivate why and check if it's there.}

\subsection*{Numerical Results, Scattering Spectra}
